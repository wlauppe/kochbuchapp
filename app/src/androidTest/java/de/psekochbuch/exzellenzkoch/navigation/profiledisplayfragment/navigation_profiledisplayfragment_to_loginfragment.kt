...
class navigation_profiledisplayfragment_to_loginfragment {
    ...
    @Test
    fun navigation_profiledisplayfragment_to_loginfragment() {
        ...
        val appCompatButton3 = onView(
            allOf(
                withId(R.id.button_profile_display_fragment_logout), withText("Ausloggen"),
                childAtPosition(
                    childAtPosition(
